  ...
  if (success) {
    return (
      <div className="w-full max-w-sm text-center">
        <div className="w-12 h-12 mx-auto mb-4 bg-link/10 rounded-full flex items-center justify-center">
          <Mail className="w-6 h-6 text-link" />
        </div>
        ...
        <Link
          href="/login"
          className="w-full py-2 px-4 bg-ink text-on-primary font-button-lg rounded-full hover:opacity-90 transition-opacity inline-block"
        >
          Back to Login
        </Link>
      </div>
    ...
    <div className="w-full max-w-sm">
      <div className="text-center mb-8">
        ...
        <p className="text-body-md text-body">
          Start tracking your money with MoneyTrail
        </p>
      </div>
